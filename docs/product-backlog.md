...
---
- [Voidlog Product Backlog](#voidlog-product-backlog)
- [Epic 1 — User Accounts \& Identity](#epic-1--user-accounts--identity)
  - [Story 1 — User Registration with Role](#story-1--user-registration-with-role)
    - [Acceptance Criteria](#acceptance-criteria)
  - [Story 2 — User Login](#story-2--user-login)
    - [Acceptance Criteria](#acceptance-criteria-1)
  - [Story 3 — User Logout](#story-3--user-logout)
    - [Acceptance Criteria](#acceptance-criteria-2)
  - [Story 4 — Password Reset](#story-4--password-reset)
    - [Acceptance Criteria](#acceptance-criteria-3)
- [Epic 2 — Log Entries](#epic-2--log-entries)
  - [Story 5 — Create Log Entry](#story-5--create-log-entry)
    - [Acceptance Criteria](#acceptance-criteria-4)
  - [Story 6 — Select Activity Type](#story-6--select-activity-type)
    - [Acceptance Criteria](#acceptance-criteria-5)
  - [Story 7 — Mood Tracking](#story-7--mood-tracking)
    - [Acceptance Criteria](#acceptance-criteria-6)
  - [Story 8 — Edit Entry](#story-8--edit-entry)
    - [Acceptance Criteria](#acceptance-criteria-7)
  - [Story 9 — Delete Entry](#story-9--delete-entry)
    - [Acceptance Criteria](#acceptance-criteria-8)
- [Epic 3 — Log Organization](#epic-3--log-organization)
  - [Story 10 — Tag Entries](#story-10--tag-entries)
    - [Acceptance Criteria](#acceptance-criteria-9)
  - [Story 11 — Search Logs](#story-11--search-logs)
    - [Acceptance Criteria](#acceptance-criteria-10)
  - [Story 12 — Filter Entries](#story-12--filter-entries)
    - [Acceptance Criteria](#acceptance-criteria-11)
- [Epic 4 — Timeline \& Dashboard](#epic-4--timeline--dashboard)
  - [Story 13 — Timeline View](#story-13--timeline-view)
    - [Acceptance Criteria](#acceptance-criteria-12)
  - [Story 14 — Dashboard Overview](#story-14--dashboard-overview)
    - [Acceptance Criteria](#acceptance-criteria-13)
- [Epic 5 — Gamification](#epic-5--gamification)
  - [Story 15 — Logging Streak](#story-15--logging-streak)
    - [Acceptance Criteria](#acceptance-criteria-14)
  - [Story 16 — XP System](#story-16--xp-system)
    - [Acceptance Criteria](#acceptance-criteria-15)
  - [Story 17 — Achievements](#story-17--achievements)
    - [Acceptance Criteria](#acceptance-criteria-16)
- [Epic 6 — Insights](#epic-6--insights)
  - [Story 18 — Mood Statistics](#story-18--mood-statistics)
    - [Acceptance Criteria](#acceptance-criteria-17)
  - [Story 19 — Activity Insights](#story-19--activity-insights)
