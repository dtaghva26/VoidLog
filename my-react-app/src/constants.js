...
export const BLOCK_DEFS = [
  ...
  { id:"happy",    cat:"feel",    color:color4, label:"😄 Feel Happy",     icon:"😄", youngerLabel:"Happy", youngerIcons:"😄💛", hasInput:false },
  { id:"sad",      cat:"feel",    color:color4, label:"😢 Feel Sad",       icon:"😢", youngerLabel:"Sad", youngerIcons:"😢💙", hasInput:false },
  { id:"excited",  cat:"feel",    color:color4, label:"🤩 Feel Excited",   icon:"🤩", youngerLabel:"Excited", youngerIcons:"🤩⭐", hasInput:false },
  { id:"sleepy",   cat:"feel",    color:color4, label:"🥱 Feel Sleepy",    icon:"🥱", youngerLabel:"Sleepy", youngerIcons:"🥱🌙", hasInput:false },
  ...
  { id:"animalsound",cat:"effects", color:color3, label:"🐾 Animal Sound", icon:"🐾", youngerLabel:"Animal Sound", youngerIcons:"🐾🔊", hasInput:"select", options:["bark","meow","chirp","ribbit"] },
  ...
  { id:"feedpet",  cat:"care",    color:color3, label:"🍎 Feed Pet",       icon:"🍎", youngerLabel:"Feed", youngerIcons:"🍎🐶", hasInput:false },
  { id:"waterpet", cat:"care",    color:color3, label:"💧 Give Water",     icon:"💧", youngerLabel:"Water", youngerIcons:"💧🐾", hasInput:false },
  { id:"cleanpet", cat:"care",    color:color3, label:"🧼 Clean Pet",      icon:"🧼", youngerLabel:"Clean", youngerIcons:"🧼✨", hasInput:false },
